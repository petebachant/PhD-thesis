...
3-D case. Sensitivity to domain length was assessed as well, showing a 2\%
increase in mean power coefficient for the 2-D SST case with the domain extended
an additional two rotor diameters downstream.
