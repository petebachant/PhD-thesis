...
of a 2-D CFT. 3-D simulations are less common, but have begun to appear more
...
Howell \emph{et al.}~\cite{Howell2010}, performed both 2-D and 3-D simulations
...
over-predicted power coefficient, while the 3-D case matched well with wind
tunnel measurements near the tip speed ratio of maximum power.
...
\todo[inline]{Cite Giorgetti et al. for 2-D array analysis.}
