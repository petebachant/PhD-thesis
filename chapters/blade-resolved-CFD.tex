...
The 3-D simulations fair better at predicting the experimental measurements. The Spalart--Allmaras model's mean power coefficient was 0.24 while the SST's was 0.33. 
\todo[inline]{Get proper values for power coefficients.}
The
...
conditions, would overestimate power output by \todo[inline]{Get percentage
    overprediction of C_P.}\%.
