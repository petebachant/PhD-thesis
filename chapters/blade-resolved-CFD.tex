...
0.33, \todo[inline]{Get proper values for power coefficients.}, which represent
...
\begin{figure}
   ...
   \begin{subfigure}[b]{\textwidth}
       \centering
        ...
        width=0.8\textwidth]{BR-CFD_meancontquiv_kOmegaSST}
   ...
   \begin{subfigure}[b]{\textwidth}
       \centering
        ...
        \includegraphics[clip, trim=0 0.2in 0 0.15in,
        width=0.8\textwidth]{BR-CFD_meancontquiv_SpalartAllmaras}
