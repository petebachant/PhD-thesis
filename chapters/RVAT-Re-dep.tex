...
the UNH-RVAT rotor and turbine test bed frame were left in the tank for about a
week, and the sodium hypochlorite in which corroded the bare aluminum. To
prevent subsequent surface roughening from corrosion, the turbine and frame were
cleaned, scoured, primed, and painted flat black. It should be noted that this
did not appreciably change the baseline performance curve and wake
characteristics, which were remeasured in this experiment.
...
\todo[inline]{Get rid of all textit versus.}

\todo[inline]{Get rid of all bold subfig letters.}
