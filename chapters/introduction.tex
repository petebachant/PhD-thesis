...
\cite{Para2002}. Sandia's efforts culminated in their 34 m Test Bed, the lessons
and knowledge gained from which were used to create a ``point design'' for
commercialization \cite{Sutherland2012}. Turbine developer FloWind used the
point design and technical guidance from SNL to develop three-bladed composite
rotors for their fleet of VAWTs, resulting in moderate commercial success. The
highest power output of any VAWT---in the 1--3 MW range---was achieved by the
Canadian Lavalin Eole 64 m Research Turbine, constructed in 1986
\cite{Para2002}. 

\begin{figure}[ht]
    \caption{The Sandia 34 m Test Bed (left) and Eole 64 m (right) Darrieus
...
\begin{figure}[ht]
    ...
    \includegraphics[width=0.9\textwidth]{figures/flowind}
