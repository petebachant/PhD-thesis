...
\begin{figure}
    ...
    \caption{Vector diagram of velocity and forcing on a cross-flow turbine
        ...
        blade chord (dash-dotted line) is coincident with the tangential velocity
        (i.e., zero preset pitch), and the drag vector is magnified by a factor of
        two (approximately, relative to the lift vector) to enhance visibility.}
