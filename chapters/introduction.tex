...
$r$ is the element radius, which for a straight-bladed turbine is equal to the
rotor radius $R$. In the relative velocity coordinate system, the lift and drag
are then oriented normal and tangential to the relative velocity, respectively.
These forces ultimately produce the shaft torque, and in turn the shaft power.
...
Unsteady foil behavior has been studied extensively in rotorcraft research. In
