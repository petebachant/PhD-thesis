...
The Goude correction is derived by considering a flat plat moving along a circular path. 
...
software, so the last two terms in Equation~\ref{eq:Goude-curvature} will be
simply added to the scalar angle of attack.
