...
the local mesh length was optimal. Jha et al.~\cite{Jha2014} provides guidelines
for choosing a projection width, recommending an equivalent elliptic planform be
constructed (at least for HAWT blades) for determining a spanwise $\epsilon$
distribution.
