...
predictions from both models were similar. \todo[inline]{Check that
    Mandal--Burton perf predictions are similar.}
...
Final grid resolutions were chosen as...

These values should provide $C_P$ predictions within one percentage point of the
true solution, which is on the order of the expanded uncertainty of the
