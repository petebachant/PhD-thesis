...
\todo[inline]{Describe end effects model settings for
    RM2.}
...
similar studies of turbine wake ALM. If the studies surveyed, the mesh
...
\todo[inline]{Add Smagorinsky model details.}
