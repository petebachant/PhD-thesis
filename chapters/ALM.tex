...
\todo[inline]{Move single steady AL results here?}

\todo[inline]{Describe OpenFOAM's cell point interpolation}
...
numerical instability. \todo[inline]{Add final width of Gaussian projection}
...
\todo[inline]{Put results for how wake changes with no flow curvature model on
    here or later?}
