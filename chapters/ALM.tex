...
\todo[inline]{Come up with an explanation for why no TKE on $+y$ side of LES.}
...
too low. This may be a similar effect as with the Spalart--Allmaras RANS model,
where subgrid-scale $k$ is not calculated, which also indicates the LES may be
under-resolved, despite using a grid resolution relatively as fine or finer than
typical studies in the literature.
...
\todo[inline]{Write about LES recovery terms.}
