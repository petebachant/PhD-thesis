...
It was determined that the Goude model performed best with respect to the
near-wake characteristics, while the performance predictions from both flow
curvature models were relatively close to each other. Thus, the Goude model was
used for all simulations reported here.
