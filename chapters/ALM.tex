...
attributed to one of the models' tuning constants, e.g., $\Delta
\alpha_\mathrm{DS_0}$, the difference in the static and dynamic stall reference
angles. \todo[inline]{Test changing this constant.}
