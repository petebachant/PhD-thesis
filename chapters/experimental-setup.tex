...
Summaries of turbine measurement sensors and instrumentation are presented in
Table~\ref{tab:sensors} and Table~\ref{tab:instrumentation}, respectively.
Details on each subsystem are presented in following sections.
