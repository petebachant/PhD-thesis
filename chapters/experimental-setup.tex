...
In 2011, a turbine test bed was developed for measuring large laboratory scale
...
a pair of Sentran ZB3 500 lbf load cells, to measure overall streamwise rotor
drag (a.k.a. thrust).
...
In order to acquire high quality experimental data to get a
...
To reduce low frequency resonance in the frame caused by turbine side forces,
two pairs of steel guy wires were added.
