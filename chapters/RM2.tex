\chapter{Experimental characterization of a medium solidity cross-flow turbine}
\label{chap:RM2}
...
\todo[inline]{Add citation for paper submitted on this study.}
...
\begin{figure}
    ...
    \includegraphics[width=0.65\textwidth]{rm2-drawing}
...
\todo[inline]{Get RM2 strut covers Figure}
\begin{figure}
%    \includegraphics[width=0.95\textwidth]{strut_covers.eps}
...
Figure~\ref{fig:exp-setup}, a 36 m long facility with a 3.66 m wide by 2.44 m deep
...
Figure~\ref{fig:exp-setup-photo} and Figure~\ref{fig:exp-setup}, respectively.

\begin{figure}
    \centering
    
%    \includegraphics[width=0.95\textwidth]{turbine-test-bed-photo}
...
\begin{figure}
    \includegraphics[width=0.9\textwidth]{RM2-tow-tank_cp_curves}
...
\begin{figure}
    \includegraphics[width=0.9\textwidth]{RM2-tow-tank_cd_curves}
...
\begin{figure}
    \includegraphics[width=\textwidth]{RM2-tow-tank_perf_re_dep}
...
\begin{figure}
    \includegraphics[width=\textwidth]{RVAT-Re-dep_meancontquiv_10}
...
\begin{figure}
    \includegraphics[width=\textwidth]{RM2-tow-tank_meancontquiv}
...
Figure~\ref{fig:kcont} shows the turbulence kinetic energy in the turbine wake. We
...
\begin{figure}
    \includegraphics[width=\textwidth]{RVAT-Re-dep_k_contours_10}
...
\begin{figure}
    \includegraphics[width=\textwidth]{RM2-tow-tank_k_contours}
