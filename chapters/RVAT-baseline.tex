...
can be identified with the study by Brochier \etal, namely the assymetry of the
mean velocity profile and how its shape changes on the side of the turbine where
the blade faces into the flow---positive $y$ for our experiments and negative
for theirs~\cite{Brochier1986}.
...
right at the right edge of the rotor at $\lambda = 1.4$. This shows the
potential for control over diversion of the flow in the near-wake.
